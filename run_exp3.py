...
parser.add_argument('--z-dim-app', type=int, default=128,
...
parser.add_argument('--save-path', type=str, default='backup/exp3',
...
parser.add_argument('--image-path', type=str, default='images/exp1',
...
scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, 450*len(data_loader), eta_min=1e-8, last_epoch=-1)
