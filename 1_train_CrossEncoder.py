...
# image saving
parser.add_argument('--save-image-samples', type=str, default=0,
...
parser.add_argument('--save-freq-images', type=int, default=9999999999,
...
scheduler = optim.lr_scheduler.StepLR(optimizer,step_size=20*len(data_loader),gamma = 0.5)
