...
parser.add_argument('--z-dim-app', type=int, default=256,
                    help='size of 1D latent code for appearance (default: 32)')
parser.add_argument('--z-dim-gaze', type=int, default=64,
...
parser.add_argument('--save-path', type=str, default='backup/exp8-resnet18',
