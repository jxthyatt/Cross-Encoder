...
def get_filelist(path,images_same_id):
    ...
    for dir_file in dir_or_files:
        ...
        if os.path.isdir(dir_file_path):
            ...
            if dir_file_path[-5:]=='l.jpg':
                img_path_l = dir_file_path
                img_path_r = dir_file_path[:-5]+'r.jpg'
...
class ImagerLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        'name_1_r': path_source_1_r, 'name_1_l': path_source_1_l,
        'name_2_r': path_source_2_r, 'name_2_l': path_source_2_l,}
